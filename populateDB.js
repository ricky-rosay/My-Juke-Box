var populate = function(db) {
    ...
    db.Song.bulkCreate([
      ...
      { songName: "Thunder Road", genre: "Rock", artist: "Bruce Springsteen" },
      { songName: "Johnny B Goode", genre: "Rock", artist: "Chuck Berry" },
      ...
      { songName: "Sweet Child of Mine", genre: "Rock", artist: "Guns N Roses" },
      { songName: "Paranoid", genre: "Rock", artist: "Black Sabbath" },
      { songName: "We Will Rock You", genre: "Rock", artist: "Queen" },
      { songName: "Smoke on the Water", genre: "Rock", artist: "Deep Purple" },
      ...
      { songName: "TiK ToK", genre: "Pop", artist: "Kesha" },
      { songName: "Bad Guy", genre: "Pop", artist: "Billie Eilish" },
      { songName: "Diamonds", genre: "Pop", artist: "Rihanna" },
      { songName: "Poker Face", genre: "Pop", artist: "Lady Gaga" },
      { songName: "Motivation", genre: "Pop", artist: "Normani" },
